...
Main = (function()
	...
	Main.Error = function(str)
		if rconsoleprint then
			rconsoleprint("h1iy ERROR: "..tostring(str).."\n")
			wait(9e9)
		else
			error(str)
		end
	...
	Main.LoadModule = function(name)
		if Main.Elevated then -- If you don't have filesystem api then ur outta luck tbh
			...
			elseif _G.DebugLoadModel then -- Load Debug Model File
				...
				local filePath = "h1iy/ModuleCache/"..name..".lua"
	...
	Main.IncompatibleTest = function()
		local function incompatibleMessage(reason)
			...
			t.TextWrapped = true
			t.TextScaled = true
			t.Text = "\n\n\n\n\n\n\n\nHello user,\nh1iy Hub requires a compatible executor.\nPlease consider getting a better executor.\n\nIncompatible Reason: "..reason.."\n\n\n\n\n\n\n\n"
	...
	Main.LoadSettings = function()
		local s,data = pcall(env.readfile or error,"h1iySettings.json")
	...
	Main.FetchAPI = function()
		...
		if Main.Elevated then
			if Main.LocalDepsUpToDate() then
				local localAPI = Lib.ReadFile("h1iy/rbx_api.dat")
				if localAPI then 
					rawAPI = localAPI
				else
	...
	Main.FetchRMD = function()
		...
		if Main.Elevated then
			if Main.LocalDepsUpToDate() then
				local localRMD = Lib.ReadFile("h1iy/rbx_rmd.dat")
				if localRMD then 
					rawXML = localRMD
				else
					Main.DepsVersionData[1] = ""
	...
	Main.CreateIntro = function(initStatus) -- TODO: Must theme and show errors
		local gui = create({
			...
			{5,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=4,Name="Title",Parent={3},Position=UDim2.new(0,-190,0,15),Size=UDim2.new(0,100,0,50),Text="h1iy",TextColor3=Color3.new(1,1,1),TextSize=50,TextTransparency=1,}},
			...
			{11,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Creator",Parent={2},Position=UDim2.new(1,-110,1,-20),Size=UDim2.new(0,105,0,20),Text="Developed by badscarz",TextColor3=Color3.new(1,1,1),TextSize=14,TextXAlignment=1,}},
	...
	Main.SetMainGuiOpen = function(val)
		...
		Main.MainGui.OpenButton.Text = val and "X" or "h1iy"
	...
	Main.SetupFilesystem = function()
		...
		makefolder("h1iy")
		makefolder("h1iy/assets")
		makefolder("h1iy/saved")
		makefolder("h1iy/plugins")
		makefolder("h1iy/ModuleCache")
	end
	...
	Main.Init = function()
		...
		if Main.Elevated then
			local fileVer = Lib.ReadFile("h1iy/deps_version.dat")
		...
		if Main.Elevated and env.writefile and not Main.LocalDepsUpToDate() then
			env.writefile("h1iy/deps_version.dat",Main.ClientVersion.."\n"..Main.RobloxVersion)
			env.writefile("h1iy/rbx_api.dat",Main.RawAPI)
			env.writefile("h1iy/rbx_rmd.dat",Main.RawRMD)
		end
